...
paletteList$"observable.observable10" <- c(
  "Blue" = "#4269D0",
  "Orange" = "#EFB118",
  "Red" = "#FF725C",
  "Cyan" = "#6CC5B0",
...
paletteList$"cosmic.hallmarks_dark" <- c(
...
paletteList$"cosmic.hallmarks_light" <- c(
...
# Color palette inspired by COSMIC Hallmarks of Cancer
paletteList$"cosmic.signature_substitutions" <- c(
  "C>A" = "#5ABCEB",
  "C>G" = "#050708",
  "C>T" = "#D33C32",
  "T>A" = "#CBCACB",
...
paletteList$"simpsons.springfield" <- c(
...
paletteList$"futurama.planetexpress" <- c(
...
paletteList$"rickandmorty.schwifty" <- c(
...
paletteList$"startrek.uniform" <- c(
...
paletteList$"flatui.flattastic" <- c(
...
# )
#
# paletteList$"material"$"deep-purple" <- c(
...
# )
#
# paletteList$"material"$"light-blue" <- c(
...
# )
#
# paletteList$"material"$"light-green" <- c(
...
# )
#
# paletteList$"material"$"deep-orange" <- c(
...
# )
#
# paletteList$"material"$"blue-grey" <- c(
